...
<style type="text/css">
	*{ 
	...
	.cols li.col2{ /* cols 클래스에 li태그에 cols2클래스 */
	 	width:350px;
	 	
	}
	.cols li.col2 input.hp{ /* cols 클래스에 li태그에 cols2클래스 */
	 	width:40px;
	...
	<ul id = "joinForm">
		...
		<li> <!-- 이메일 -->
			<ul class = "cols">
			  ...
			  <li class = "col2"><input type ="email" type = "text">
			  	  <select id = "email2">
			  	  	 <option>선택</option>
		...
		<li> <!-- 자기소개  -->
			<ul class = "cols"> 
			  ...
			  <li class = "col2"><textarea rows="5" cols="35"></textarea></li>
		   </ul>
		</li>
		<li> <!-- 파일첨부 -->
			<ul class = "cols">
